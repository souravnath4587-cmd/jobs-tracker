...
To create and insert a new element into the DOM using JavaScript, you need to follow a two-step process: create a new element by(document.create("div) and initialize id name using append method into new element.
...
Event delegation is a design pattern in javascript where a single event listener is attached to a parent elemet to manage all its individual children element.
